...
import {
  PriceHistory,
  TokensPriceHistory
} from '../../../../apps/cryptowars/frontend/src/app/pages/HomePage/slice/types';
import moment from 'moment';

export class LocalStorageTokensHistoricalPricesRepository
  implements TokensHistoricalPricesRepository
{
  ...
  save(transactions: Array<Transaction>): void {
    let tokensPriceHistory: TokensPriceHistory = JSON.parse(
      localStorage.getItem('tokensPriceHistory') ?? '{}'
    );
