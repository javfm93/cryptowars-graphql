...
export type HomePagePlayerQuery = {
  __typename?: 'Query'
  GetPlayer: { __typename?: 'Player'; towns: Array<{ __typename?: 'Town'; id: string }> }
}

export type PlayerTownsQueryVariables = Exact<{ [key: string]: never }>

export type PlayerTownsQuery = {
  __typename?: 'Query'
  GetPlayerTowns: { __typename?: 'Towns'; towns: Array<{ __typename?: 'Town'; id: string }> }
}
...
export type PlayerTownHeaderQuery = {
  __typename?: 'Query'
  GetPlayerTown: {
    __typename?: 'Town'
    id: string
    ...
    buildings: {
      ...
      warehouse: {
        ...
        assets: {
          __typename?: 'WarehouseAssets'
          essence: { __typename?: 'WarehouseAsset'; stored: number; lastStorageUpdate: string }
        }
      }
    }
  }
...
export type JoinWorldPageQuery = {
  __typename?: 'Query'
  GetWorlds: {
    __typename?: 'Worlds'
...
export const PlayerTownsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<PlayerTownsQuery, PlayerTownsQueryVariables>
export const PlayerTownDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PlayerTown' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'GetPlayerTown' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<PlayerTownQuery, PlayerTownQueryVariables>
export const PlayerTownHeaderDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PlayerTownHeader' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'generationPerHour' } }
                          ]
                        }
                      },
                      {
                                ...
                                selections: [
                                  {
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        {
                                          kind: 'Field',
                                          name: { kind: 'Name', value: 'lastStorageUpdate' }
                                        }
                                      ]
                                    }
                                  }
...
} as unknown as DocumentNode<PlayerTownHeaderQuery, PlayerTownHeaderQueryVariables>
export const JoinWorldPageDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'JoinWorldPage' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<JoinWorldPageQuery, JoinWorldPageQueryVariables>
...
export const WorldMapDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'WorldMap' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<WorldMapQuery, WorldMapQueryVariables>
