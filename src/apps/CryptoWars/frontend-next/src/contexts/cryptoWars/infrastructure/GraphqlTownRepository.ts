...
import { PlayerTownHeaderQuery, PlayerTownQuery, PlayerTownsQuery, UnexpectedError } from "../../../../../../../../tests/apps/CryptoWars/backend/__generated__/graphql";
...
export class GraphqlTownRepository implements TownRepository {
  ...
  async getTownHeader(id: string): Promise<Result<PlayerTownHeaderQuery["GetPlayerTown"], UnexpectedError>> {
