...
import { PlayerTownHeaderQuery, PlayerTownQuery, PlayerTownsQuery, UnexpectedError } from '@/contexts/shared/domain/__generated__/graphql';
...
export abstract class TownRepository {
  ...
  abstract getTownHeader(id: string): Promise<Result<PlayerTownHeaderQuery["GetPlayerTown"], UnexpectedError>>;
}